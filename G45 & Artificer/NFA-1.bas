...
Function InitializePrivate() Uint64
    ...
    300 STORE("artificerFee", 3)
    310 STORE("royalty", 3)
    320 STORE("ownerCanUpdate", 0)
    330 STORE("nameHdr", "Dero0")
    340 STORE("descrHdr", "DERO")
    350 STORE("typeHdr", "Images")
    360 STORE("iconURLHdr", "https://ibb.co/3MsRCQp")
    370 STORE("tagsHdr", "#DERO")
    400 STORE("fileCheckC", "9d090257fe86c9136ab112ddaebf86f6e22fd6495c587c9152a4c28cd0bb8a3")
    410 STORE("fileCheckS", "2abbe64d8ff03f05049b900e86cbe5dd7b96280e23f8007b4382603cb494743f")
    420 STORE("fileURL", "https://ibb.co/3MsRCQp")
    430 STORE("fileSignURL", "https://ibb.co/3MsRCQp.sign")
    440 STORE("coverURL", "https://ibb.co/3MsRCQp")
    450 STORE("collection", "Test Collection")
...
Function init() Uint64
    ...
    40  STORE("artificerAddr", ADDRESS_RAW("deto1qyvyeyzrcm2fzf6kyq7egkes2ufgny5xn77y6typhfx9s7w3mvyd5qqynr5hx"))
    ...
    140 STORE("listType", "")
    150 STORE("charityDonatePerc", 2)
    160 STORE("startPrice", 1)
    170 STORE("currBidPrice", 1)
